...
export const BRANDS: Brand[] = [
  {
    ...
    approach: [
      ...
      "Generated 500+ AI-crafted images across listings, lifestyle, and social formats with one unified aesthetic.",
    ...
    scope: [
      ...
      "Lifestyle library (350+ scenes across home, bath, kitchen)",
